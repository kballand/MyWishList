...
<section class="basicForm">
    <form id="accountModificationForm" method="post" novalidate>
        ...
        <div class="errorDisplayedField">
            ...
            <span class="displayedError fieldEmptyError" id="accountFirstNameEmptyError">
        ...
        <div class="errorDisplayedField">
            ...
            <span class="displayedError fieldEmptyError" id="accountModificationLastNameEmptyError">
        ...
        <div class="errorDisplayedField">
            ...
            <span class="displayedError usernameUniqueError" id="accountModificationUsernameUniqueError">
        ...
        <div class="errorDisplayedField">
            ...
            <span class="displayedError emailInvalidError" id="accountModificationEmailInvalidError">
